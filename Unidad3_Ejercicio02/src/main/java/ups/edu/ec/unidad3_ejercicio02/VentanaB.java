...
public class VentanaB extends JFrame{
    ...
    private List<JPanel> jPanelList;
     ...
     public void iniciarTextos(){
        ...
        this.jTextFieldList.get(4).setColumns(20);
        this.jTextFieldList.get(5).setColumns(20);
        this.jTextFieldList.get(6).setColumns(20);
        this.jTextFieldList.get(7).setColumns(20);
        this.jTextFieldList.get(8).setColumns(20);
